...
const contentClassName =
  "fixed inset-0 m-auto h-fit w-80 max-w-full rounded-lg border border-gray-200 bg-white p-6 text-gray-900 shadow-lg transition-[opacity,scale] duration-150 starting:scale-95 starting:opacity-0 data-[state=closed]:scale-95 data-[state=closed]:opacity-0";
